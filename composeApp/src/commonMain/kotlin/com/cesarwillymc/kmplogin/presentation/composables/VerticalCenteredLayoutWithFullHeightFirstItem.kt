...
fun VerticalCenteredLayoutWithFullHeightFirstItem(
    ...
    Layout(modifier = modifier, content = content) { measurables, constraints ->
        ...
        val maxHeightItems =  measurables.maxOf { it.minIntrinsicHeight(constraints.maxHeight) }
        layout(constraints.maxWidth, maxHeightItems) {
            ...
            for (i in placeables.lastIndex downTo ZERO) {
                ...
                val currentHeight = maxHeightItems/2 - placeables[i].measuredHeight/2
            ...
            if (measurablesMoreThanOne){
                ...
                measurables[ZERO].measure(constraints.copy(maxWidth = xPosition, minWidth = ZERO)).let {
                    it.placeRelative(y = maxHeightItems/2 - placeables[ZERO].measuredHeight/2, x = ZERO)
                }
            }
        }
    }
